...
app.post("/submit", (req, res) => {
  ...
  //Then:
  var randomadjno = Math.floor(Math.random() * adj.length)+1;
  var randomnounno = Math.floor(Math.random() * noun.length)+1;
  //1. You should randomly pick an adjective from the const "adj" and a noun from const "noun",
  //scroll down to see the two arrays.
  const randomAdj = adj[randomadjno];
  const randomNoun = noun[randomnounno];
